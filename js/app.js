...
function loadModel() {
    ...
    // Define los elementos SVG que quieres animar
    let lineLength = document.querySelector('#line-length');
    let lineWingspan = document.querySelector('#line-wingspan');
    let circlePhalange = document.querySelector('#circle-phalange');

    // Calcula la longitud de los trazos
    let lineLengthLength = lineLength.getTotalLength();
    let lineWingspanLength = lineWingspan.getTotalLength();
    let circlePhalangeLength = circlePhalange.getTotalLength();

    // Configura los SVG para la animación de "dibujo"
    lineLength.style.strokeDasharray = lineLengthLength;
    lineLength.style.strokeDashoffset = lineLengthLength;
    lineWingspan.style.strokeDasharray = lineWingspanLength;
    lineWingspan.style.strokeDashoffset = lineWingspanLength;
    circlePhalange.style.strokeDasharray = circlePhalangeLength;
    circlePhalange.style.strokeDashoffset = circlePhalangeLength;
    ...
    function onModelLoaded() {
        ...
        setupAnimation(object, lineLengthLength, lineWingspanLength, circlePhalangeLength);
    }
...
// Envuelve la llamada a loadModel() en un evento DOMContentLoaded
